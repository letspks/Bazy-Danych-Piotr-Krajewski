...
--tworzenie tabelek
CREATE TABLE geol.eon(id_eon INT primary key,eon varchar(30));
CREATE TABLE geol.era( id_era INT primary key, era varchar(30),
		id_eon INT );
ALTER TABLE geol.era add foreign key (id_eon) references geol.eon (id_eon);
 CREATE TABLE geol.okres(id_okres INT primary key, okres varchar(30),
		id_era INT );
ALTER TABLE geol.okres add foreign key (id_era) references geol.era (id_era);
CREATE TABLE geol.epoka( id_epoka INT primary key, epoka varchar(30),
		id_okres INT );
ALTER TABLE geol.epoka add foreign key (id_okres) references geol.okres (id_okres);
CREATE TABLE geol.pietro(id_pietro INT primary key, pietro varchar(30),
		id_epoka INT );
ALTER TABLE geol.pietro add foreign key (id_epoka) references geol.epoka (id_epoka);
...
--stworzenie tabeli geochronologicznej laczac wszystkie tabele
